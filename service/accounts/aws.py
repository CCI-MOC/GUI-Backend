        ...
        try:
            id_member = IdentityMembership.objects.filter(
                ...
                identity__credential__value__in=[
                    access_key, secret_key]).distinct()[0]  # noqa=F821
            ...
            Credential.objects.get_or_create(
                identity=identity, key='key', value=access_key)[0]  # noqa=F821
            Credential.objects.get_or_create(
                identity=identity, key='secret', value=secret_key)[0]  # noqa=F821
